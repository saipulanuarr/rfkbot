...
┗━━━━━━━━⬣`.trim(),
    ...
    await conn.send3ButtonLoc(m.chat, await (await fetch(`https://i.ibb.co/KsMxC5P/thumb.jpg + teks`)).buffer(), text.trim(), footer, 'Pemilik Bot', '.owner', 'Donasi', '.donasi', 'Rules', '.infobot', m)
