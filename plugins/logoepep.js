...
conn.logoepep = conn.logoepep ? conn.logoepep : {}
 ...
 conn.sendFile(m.chat, global.API('xteam', '/api/epep', 'APIKEY', { text, }), 'Logo Epep.png', 'Nih udah jadi Logo epepmu...\n *_Tetap Support:_* *King Of Bear*', m, 0, { thumbnail: await (await fetch(global.API)).buffer() })
}
